    ...
    <div className="w-full max-w-[100vw]  ">
      ...
      <div className="w-[100%] text-white flex lg:flex-row flex-col justify-around px-[10vw] items-center" style={{ backgroundImage: "url('/src/assets/waves.b413f6f1.svg')", backgroundRepeat: "no-repeat", backgroundPosition: "center", backgroundSize: "cover" }}>
        <div className="flex flex-col items-center justify-center gap-[4vw] w-[90%] md:w-[80%] lg:w-[40%] mt-[5vw] px-[2vw] rounded-[2vw]">
          ...
          <div className="w-[120%] text-[2.8vw] md:text-[2.1vw] lg:text-[.9vw] font-semibold mb-[3vw] lg:mb-[0vw] text-gray-400">
        ...
        <div className='text-[5vw] md:[3.8vw] lg:text-[1.2vw] w-full lg:w-[40%] mx-auto'>
          <div className='p-[4vw]'>
            <h1 className="font-bold  mb-[0.8vw]">Get What You Pay For!</h1>
      ...
      <div className="flex relative flex-col lg:flex-row items-center text-white mt-[5vw] text-[5vw] md:text-[3.2vw] lg:text-[2vw] font-bold w-[full] text-center mx-auto p-[2vw] justify-between gap-[2vw]">
        <div className="w-full mx-auto lg:w-[50%] flex flex-col justify-center items-center lg:items-start p-[2vw]">
          <div className=''>
            <p className="my-[3vw] lg:my-0">Start Trading today with <span className='text-[#42cba4]'>PocketBits</span></p>
          </div>
      ...
      <div className="text-white font-bold w-[70%] mx-[auto] text-[1.2vw]">
        ...
        <div className="mb-[12vw] mt-[6vw] md:mb-[8vw] lg:my-[2vw]">
          <h1 className="text-[5vw] md:text-[4.5vw] lg:text-[2vw] my-[3vw]">Get Started in a few minutes</h1>
          <div className="animations flex flex-col relative lg:flex-row justify-center lg:justify-around items-center mt-[12vw] md:mt-[2vw] md:mb-[2vw] mb-[20vw] gap-[8vw] md:gap-[6vw] lg:gap-[0vw] lg:my-[3vw] w-[100%] h-[95vw] md:h-[80vw] lg:h-[12vw] ">
            <div className="w-[35%] h-[33%] md:h-[25%] md:w-[22.5%] lg:w-[17%] flex justify-center lg:h-[100%] border-[0.8vw] border-[#42cba4] p-[4vw]  lg:p-[.8vw] rounded-[50%]">
              <img src={create} className='w-[100%]' />
            </div>
            <div className="w-[35%] h-[33%] md:h-[25%] md:w-[22.5%] lg:w-[17%] flex justify-center lg:h-[100%] border-[0.8vw] border-[#42cba4] p-[4vw] lg:p-[0.8vw] rounded-[50%]">
              <img src={finish} className='w-[100%]' />

            </div>
            <div className="w-[35%] h-[33%] md:h-[25%] md:w-[22.5%] lg:w-[17%]  flex justify-center lg:h-[100%] border-[0.8vw] border-[#42cba4] p-[4vw] lg:p-[1.2vw] rounded-[50%]">
              <img src={start} className='w-[100%]' />
            </div>
            <div className='flex flex-col absolute gap-[30vw] md:gap-[22vw] translate-y-[17vw] md:translate-y-[13vw] lg:translate-y-[9vw] lg:gap-[0vw] lg:flex-row items-center lg:justify-around text-[3.2vw] md:text-[2.6vw] lg:text-[1.4vw] text-center w-full'>
      ...
      <div style={{ backgroundImage: "url('/src/assets/candlestick patterns.f731363f.svg')", backgroundRepeat: "no-repeat", backgroundPosition: "center", backgroundSize: "cover" }} className="flex flex-col items-center justify-around mt-[6vw]">
        <div className="w-[90%] lg:w-[70%] h-[50vw] lg:h-[25vw] mx-auto rounded-[2vw] bg-gray-600/50 flex flex-col justify-center items-center p-[vw]">
